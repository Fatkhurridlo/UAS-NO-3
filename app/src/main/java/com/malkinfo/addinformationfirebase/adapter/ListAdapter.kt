...
RecyclerView.Adapter<ListAdapter.ListViewHolder>()
{
    inner class ListViewHolder(var v:View): RecyclerView.ViewHolder(v){
        ...
        var descriT = v.findViewById<TextView>(R.id.nimMhs)
        var IPK = v.findViewById<TextView>(R.id.IPKmhs)
        var MTKL = v.findViewById<TextView>(R.id.mtkl)
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
       var newList = teacherList[position]
        ...
        holder.IPK.text = newList.ipk
        holder.MTKL.text = newList.mtkl
        ...
        holder.v.setOnClickListener {
            ...
            mIntent.putExtra("IPKIT",ipk)
            mIntent.putExtra("matkultit",matkul)
